...
<section class="fon">
    <div class="info">
        <div class="info">
            ...
            <p><?php echo isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : ''; ?></p>
        </div>
    </div>
    ...
    <script>
        ...
        (function () {
            ...
            var modal1 = $modal({
                ...
                content: ' <p>Ваш мастер:<?= $rec->nameMasters ?></p> <p>Вы записались на <?= date("d.m.Y", strtotime($rec->date_reg)); ?> в <?= substr($rec->time, 0, -3); ?></p> <p>Услуга: <?= $rec->title ?></p> <p>К оплате: <?= $rec->price ?>&#8381;</p><br> <p>Для уточнения информации о точном времени вашей записи вы можете позвонить на личный номермастера <?= $rec->tel ?> <br> или по номеру салона +7 (908) 055-21-77</p><br> <?php endforeach; ?>'
            });
